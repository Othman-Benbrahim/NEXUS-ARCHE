...
- **Mathématiques** : systèmes dynamiques, topologie, réseaux, probabilité
- **Anthropologie** : Donald Brown (*The Universal People*, 1991)
- **Symbolique** : Alphabet STÈLE (écosystème IRIS)

---

## Statut

Draft v0.1 — À tester sur situations réelles avant stabilisation.
